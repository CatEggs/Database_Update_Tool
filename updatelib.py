...
def export(df1, filename, path):
        ...
        if not case_list:
                ...
                for i in range(0, len(case_list)):
                        ...
                        df_cms = hi[['Claim Ref #',	'COL LienId',	'COL LienType',	'COL Question #',	'COL Status',	'COL Amount',	'COL Lienholder',	'COL Id',	'COL Claim number',	'COL CaseName',	'CaseName',	'Case Name',	'ThirdPartyId',	'SLAM LienId',	'SLAM LienType',	'SLAM Question #',	'SLAM Status',	'SLAM Lienholder',	'JAM SLAM FD Amount',	'JAM SLAM Global Amount',	'SLAM Amount',	'FPV SLAM FD Amount',	'FPV SLAM Global Amount',	'FPV SLAM True FD Amount',	'SLAM_LienType',	'SLAM LienType (converted)',	'SLAM Stage',	'SLAM ClosedReason',	'SLAM OnBenefits',	'Prob_Issue',	'Prob_Notes',	'BUDNSFW_ClientIssue_CMS',	'BUDNSFW_LienIssue',	'Current_Escrow',	'Percent Escrow Remaining',	'Claimant on CSR?_y',	'SLAM Final',	'Client Truly Final',	'Prob_Check',	'ThirdPartyId_Match?',	'New Liens?',	'Status_Check',	'Updated Status',	'LienType_Check',	'LienId_Check',	'Amount_Check',	'Updated Amount',	'Question_#_Check',	'Lienholder_Check',	'InSLAM_Check',	'Initial_CMS_Label',	'CMS_Label']]
